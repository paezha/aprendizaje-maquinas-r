...
![Regresión lineal múltiple con una variable respuesta ($Y$) y dos variables predictoras ($X_1,X_2)$\label{fig:MLR}](MLR.jpg){width='350px'}
...
![Base de datos de empleados](Datos_empleados.png){width='600px'}
...
library(glue)
library(here)
datos <- read_xlsx(glue::glue(here::here(), "/Regresion-Lineal/Datos_de_empleados.xlsx"))
```
